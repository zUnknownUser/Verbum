...
Atualização Ask: [GPT-5.6 Luna](https://developers.openai.com/api/docs/models/gpt-5.6-luna) custa US$ 0,20/1,20 por milhão de tokens de entrada/saída; cache lido US$ 0,02 e escrita de cache 1,25× a entrada. Sem detalhes de cache, o contador usa conservadoramente US$ 0,25/milhão de entrada. A reserva de US$ 0,01 cobre o limite de 32.000 bytes de prompt e 1.024 tokens de saída. Embeddings, pipeline e realtime não mudam de modelo.

Narração Gemini e reserva de áudio: [NARRACAO_GEMINI_2026-09-16.md](NARRACAO_GEMINI_2026-09-16.md).
